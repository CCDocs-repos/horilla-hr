# Generated by Django 4.2.24 on 2026-09-23 20:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "kind",
                    models.CharField(
                        choices=[("late", "Late"), ("out", "Out")], max_length=10
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="ccdocs_attendance_notices",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="ccdocs_attendance_days",
                        to="employee.employee",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="ccdocs_attendance.attendancenotice",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="ccdocs_attendance_links",
                        to="employee.employee",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source",
                    models.CharField(
                        choices=[("engine", "Engine"), ("manager", "Manager page")],
                        default="engine",
                        max_length=10,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="ccdocs_attendance.dayresult",
                    ),
                ),
                (
                    "employee",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="ccdocs_attendance_points",
                        to="employee.employee",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["employee", "day"],
                        name="ccdocs_atte_employe_f0862f_idx",
                    )
                ],
            },
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["from_date", "to_date"], name="ccdocs_atte_from_da_0b5fd1_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="attendancenotice",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(
                    ("valid_to__isnull", True), ("dialer_user__isnull", False)
                ),
                fields=("dialer_user",),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    ("dialer_user__isnull", False),
                    ("webwork_email__isnull", False),
                    _connector="OR",
                ),
